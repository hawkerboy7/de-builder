...
Project = class Project {
  ...
  typeOne() {
    ...
    fs.mkdirp(this.server.folders.temp.client).then(this.handle);
    return fs.mkdirp(this.server.folders.temp.server).then(this.handle);
  }

  typeTwo() {
    fs.mkdirp(this.server.folders.src.index).then(this.handle);
    return fs.mkdirp(this.server.folders.temp.index).then(this.handle);
  }
