	...
	initialized: (w) =>
		...
		if w._browserSyncIndicator
			...
			for folder in @config.multi
				...
				bundle.require "./node_modules/socket.io-client/lib/index.js", expose: "socket.io-client"
			...
			# Make socket.io-client require"able
			w.require "./node_modules/socket.io-client/lib/index.js", expose: "socket.io-client"
